...
import logoImg from 'assets/images/logo/fiuni.png';
...
export default function AuthBackground() {
  ...
  return (
    ...
    >
      <img src={logoImg} alt="Background" style={{ width: '100%', height: 'calc(100vh - 200px)', objectFit: 'cover', viewBox: "0 0 405 809", fill: "none" }} />
